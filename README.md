...
1. Select a single mouse that was treated with Capomulin and generate a line plot of tumor volume vs. time point for that mouse.
...
# Hint
All four box plots should be within the same figure. Use this https://matplotlib.org/stable/gallery/statistics/boxplot_demo.html pageLinks to an external site. for help with changing the style of the outliers.
